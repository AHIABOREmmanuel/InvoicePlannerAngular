...
export class FactureService {
  ...
  updateStatus(trackingId: string, etat: string): Observable<GlobalResponse<FactureResponse>> {
    return this.http.put<GlobalResponse<FactureResponse>>(`${this.apiUrl}/${trackingId}/status`, { etat });
  }
}
